...
public class ListagemDeProdutos {
    ...
    static void VisualizarTodosPrudutos() {
        System.out.println("Produtos cadastrados:");
        for (Produto produto : produtos) {
            System.out.println("Código: " + produto.getId() + " - " +  produto);
        }
        if (produtos == null) {
 ...
 // Parei aqui
    ...
    public Produto escolherProduto() {
        int codigoDoProdutoEscolhido = main.Leitor.lerInteiro("Escolha um produto: ");
